                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="xzoom-container">
                            ...
                            <div class="xzoom-thumbs pt-3">
                                ...
                                <a href="{{ asset($image->other_image) }}"><img class="xzoom-gallery" width="80" src="{{ asset($image->other_image) }}"  xpreview="{{ asset($image->other_image) }}" title="The description goes here"></a>
                                @endforeach
                            </div>
                        </div>  
                    </div>
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                            ...
                            <p class="category">
                                <i class="lni lni-tag"></i> Product Category:<a
                                    href="javascript:void(0)">{{ $product->category->name }}</a>
                            </p>
                            <p class="category">
                                <i class="lni lni-tag"></i> Product Sub-category:<a
                                    href="javascript:void(0)">{{ $product->subCategory->name }}</a>
                            </p>
                            <p class="category">
                                <i class="lni lni-tag"></i> Product Brand:<a
                                    href="javascript:void(0)">{{ $product->brand->name }}</a>
                            </p>
