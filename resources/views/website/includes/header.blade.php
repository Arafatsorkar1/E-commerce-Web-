                     ...
                     <div class="top-end">
                        @if(Session::get('customer_id'))
                         <div class="user">
                            ...
                            <span> Hello </span> {{Session::get('customer_name')}}
                             <ul class="user-login">
                                <li>
             ...
             <div class="row align-items-center">
                 <div class="col-lg-3 col-md-3 col-7">
                     ...
                     <a class="navbar-brand" href="{{ route('home') }}">
                        {{-- <span style="font-size: 25px; font-weight:1000">FASHION</span><span class="text-dark" style="font-weight: 800">365</span> --}}
                         {{-- <img src="{{ asset('website/assets/images/logo/logo.svg') }}" alt="Logo"> --}}
                         {{-- <img src="{{ asset('website/assets/images/logo/esellerlogo.png') }}" alt="Logo" style="height: 90px; width:90px"> --}}
                         <img src="{{ asset('website/assets/images/logo/esellerlogo2.png') }}" alt="Logo" style="height: auto; width:90px">
                     </a>
                                 ...
                                 <div class="shopping-item">
                                     ...
                                     <ul class="shopping-list">
                                         ...
                                         @foreach (ShoppingCart::all() as $item)
                                             <li>
                                                 <a href="{{route('remove-from-cart',['id' => $item->__raw_id])}}" class="remove" title="Remove this item"><i
